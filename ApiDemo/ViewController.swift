...
func getData(){
    ...
    let request = NSMutableURLRequest(url: NSURL(string: "https://maps.googleapis.com/maps/api/place/textsearch/json?query=\(searchvalue)&key=AIzaSyC1QIPXm3AbhET9rhOAKVTac_hRtr8yEVc")! as URL,
           ...
           for object in array!
             {
               ...
               let value = location(name: name as! String , address: address as! String, rating: rating as! NSNumber, photoRef: "", photoUrl: "")
    ...
    func fetchImage()
    {
         ...
         let ref = item.photoRef
            print(ref)
        
        let request = NSMutableURLRequest(url: NSURL(string: "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=\(ref)&key=AIzaSyC1QIPXm3AbhET9rhOAKVTac_hRtr8yEVc")! as URL,
                                          cachePolicy: .useProtocolCachePolicy,
                                          timeoutInterval: 10.0)
        request.httpMethod = "GET"
            ...
            if (error != nil)
             {
            ...
            else
              {
                 ...
                 // let image = UIImage(data: PhotoUrl)
                 // self.locationarray.append(image)
...
extension ViewController: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let url = NSURL(string: self.locationarray[indexPath.row].photoRef)
         {
